# Phase 04 · Day 03: Capture production and field evidence
...
Complete **capture production and field evidence**. End the day with **A production lab/field evidence log or a complete pending-access procedure.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** PageSpeed Insights; GSC Core Web Vitals; seven priority production URLs.
...
3. **Research/decision** — Query PSI and authorized GSC.
4. **Research/decision** — record collection dates and URL groups; do not equate lab score with field CWV; mark absent CrUX data unknown.
