# Phase 04 · Day 12: Write release and rollback runbook
...
Complete **write release and rollback runbook**. End the day with **A timed daytime-release checklist with owner, observation window, and rollback triggers.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Days 08–11 gates; `_redirects`; deployment config `wrangler.jsonc`; repository README.
...
3. **Research/decision** — Order preflight/deploy/postflight.
4. **Research/decision** — define artifact retention; specify rollback for routing, privacy, core task, and performance regressions.
