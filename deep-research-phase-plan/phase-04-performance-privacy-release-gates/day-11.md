# Phase 04 · Day 11: Set budgets and decision thresholds
...
- **Inspect exactly:** Days 01–04 evidence; report thresholds LCP <=2.5s, INP <200ms, CLS <0.1.
...
3. **Research/decision** — Separate good-target thresholds from local proxy metrics.
4. **Research/decision** — set run variance and stop-ship rules; require owner approval for exceptions.
