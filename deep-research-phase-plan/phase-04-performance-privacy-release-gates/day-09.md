# Phase 04 · Day 09: Define the product and browser gate
...
Complete **define the product and browser gate**. End the day with **A repeatable smoke suite for core task success, console errors, mobile layout, and accessibility basics.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Seven priority pages; `UI_UX_SPEC.md`; `DESIGN_SYSTEM.md`.
...
3. **Research/decision** — Select synthetic fixtures.
4. **Research/decision** — specify selectors/actions/results; test keyboard and 360px viewport; define critical-console-error policy.
...
for p in ['robots.txt','sitemap.xml','UI_UX_SPEC.md']:
