# Phase 04 · Day 06: Map privacy claims to behavior
...
Complete **map privacy claims to behavior**. End the day with **A claim-to-evidence matrix and safer wording proposal for every network-capable priority tool.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** `privacy/index.html`, `security/index.html`, homepage/tool copy, Day 05 request inventory.
...
3. **Research/decision** — Search local/no-upload claims.
4. **Research/decision** — compare with observed requests; distinguish files from metadata; block absolute claims lacking evidence.
