# Phase 04 · Day 04: Audit heavy-library loading
...
Complete **audit heavy-library loading**. End the day with **A route-by-route matrix showing where PDF, OCR, image, and other heavy code loads.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Priority HTML files and referenced scripts; browser Coverage/Network panels.
...
3. **Research/decision** — Enumerate script tags/imports.
4. **Research/decision** — compare unrelated routes; record transfer/execution evidence; identify candidates without changing bundles.
