...
- **Inspect exactly:** All `*/index.html`; `sitemap.xml`; local server from `server.js`.
...
3. **Research/decision** — Start local server.
4. **Research/decision** — crawl sitemap pages; validate internal href targets and fragments; classify redirects, missing files, and intentionally external links.
