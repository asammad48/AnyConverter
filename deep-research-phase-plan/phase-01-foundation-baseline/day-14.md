...
- **Inspect exactly:** All Phase 01 daily evidence logs; `phase-01-foundation-baseline.md`; Phase 02 Day 01.
...
- Read [`day-13.md`](day-13.md) and its evidence log before starting.
...
3. **Research/decision** — Summarize knowns and unknowns.
4. **Research/decision** — list blockers and console access gaps; freeze measurement dates; identify inputs safe for architecture work.
...
for p in ['robots.txt','sitemap.xml','phase-01-foundation-baseline.md']:
...
- A concise handoff for Phase 02 Day 01.
...
Pass to Phase 02 Day 01: the decision summary, evidence-log path, raw artifact references, exact known/unknown list, unresolved blockers with owners, files/URLs/selectors inspected, and the first safe next command. State explicitly whether downstream work is **unblocked**, **partially unblocked**, or **blocked**.

## Evidence contract

| Contract field | Requirement for Day 14 |
|---|---|
