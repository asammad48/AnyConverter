...
- **Inspect exactly:** `redact-pdf/index.html`, `pdf-security/index.html`, phase overview redaction procedure.
...
3. **Research/decision** — Create synthetic input.
4. **Research/decision** — record marker and expected removal; identify copy, extraction, object, overlay-removal, and byte-search tests; do not use personal data.
...
for p in ['robots.txt','sitemap.xml','redact-pdf/index.html']:
