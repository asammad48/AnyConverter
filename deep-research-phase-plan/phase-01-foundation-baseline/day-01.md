...
- **Inspect exactly:** `sitemap.xml`, `robots.txt`, `index.html`, `reports/google-indexing-audit.csv`.
...
- Read [`../phase-01-foundation-baseline.md`](../phase-01-foundation-baseline.md) and prerequisites produced by earlier phases and its evidence log before starting.
...
3. **Research/decision** — Enumerate HTML entry points and sitemap URLs.
4. **Research/decision** — classify priority cluster samples; record mismatches as findings; create the baseline evidence log.
