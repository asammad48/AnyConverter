...
- **Inspect exactly:** Day 09–10 evidence logs; `redact-pdf/index.html`; `privacy/index.html`; `security/index.html`.
...
3. **Research/decision** — Review every attack result.
4. **Research/decision** — apply the decision threshold; specify rollback/disable/rename path; obtain security stakeholder approval before future claims.
