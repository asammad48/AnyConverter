...
- **Inspect exactly:** Priority URLs from Day 06; `robots.txt`; `sitemap.xml`; `_redirects`.
...
3. **Research/decision** — Serve the repository.
4. **Research/decision** — rerun parsers and HTTP checks; manually open representative pages; compare with earlier logs; do not implement roadmap fixes.
...
for p in ['robots.txt','sitemap.xml','robots.txt']:
