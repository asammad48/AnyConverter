...
- **Inspect exactly:** Days 01–11 evidence logs; `reports/seo-deployment-checklist-2026-08-21.md`.
...
3. **Research/decision** — Merge findings.
4. **Research/decision** — distinguish deployed, local, and unknown state; prioritize security and crawl blockers; link each issue to evidence.
...
for p in ['robots.txt','sitemap.xml','reports/seo-deployment-checklist-2026-08-21.md']:
