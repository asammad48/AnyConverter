...
- **Inspect exactly:** `redact-pdf/index.html`; browser UI; local PDF extraction/object inspection tools.
...
- Read [`day-09.md`](day-09.md) and its evidence log before starting.
...
3. **Research/decision** — Run the prepared fixture through the UI.
4. **Research/decision** — test selection, extraction, raw bytes, objects, and overlay manipulation; treat any recoverability as failure.
...
- A concise handoff for [`day-11.md`](day-11.md).
...
Pass to [`day-11.md`](day-11.md): the decision summary, evidence-log path, raw artifact references, exact known/unknown list, unresolved blockers with owners, files/URLs/selectors inspected, and the first safe next command. State explicitly whether downstream work is **unblocked**, **partially unblocked**, or **blocked**.

## Evidence contract

| Contract field | Requirement for Day 10 |
|---|---|
