...
- **Inspect exactly:** GSC Performance report; `reports/google-search-console-audit-2026-08-20.md`; daily evidence log.
...
3. **Research/decision** — Set comparison window and filters.
4. **Research/decision** — export page/query/country/device data; separate branded/non-branded using documented rules; mark metrics pending if unavailable.
