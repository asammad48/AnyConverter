...
- **Inspect exactly:** `robots.txt`, `sitemap.xml`, `_redirects`, `server.js`.
...
3. **Research/decision** — Inspect directives and sitemap declaration.
4. **Research/decision** — parse XML; compare sitemap URLs with local page directories; classify exclusions and unexpected entries.
