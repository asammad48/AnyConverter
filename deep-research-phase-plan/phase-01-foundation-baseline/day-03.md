...
- **Inspect exactly:** `index.html`, `pdf-merge/index.html`, `pdf-compress/index.html`, `redact-pdf/index.html`, `json-formatter/index.html`, `es/index.html`.
...
3. **Research/decision** — Extract canonical, robots meta, title, and status under the local server.
4. **Research/decision** — compare canonical paths with sitemap; log contradictions without inferring Google selection.
