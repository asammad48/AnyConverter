...
- **Inspect exactly:** Homepage; `/pdf-merge/`; `/pdf-compress/`; `/redact-pdf/`; `/image-converter/`; `/json-formatter/`; `/word-counter/`; `/typing-speed-test/`; `/world-clock/`; `/es/`.
...
- Read [`day-05.md`](day-05.md) and its evidence log before starting.
...
3. **Research/decision** — Prepare exact URL list.
4. **Research/decision** — inspect live/indexed state in GSC when authorized; record user-declared canonical and Google-selected canonical; never extrapolate from samples.
...
for p in ['robots.txt','sitemap.xml','/pdf-merge/']:
...
- A concise handoff for [`day-07.md`](day-07.md).
...
Pass to [`day-07.md`](day-07.md): the decision summary, evidence-log path, raw artifact references, exact known/unknown list, unresolved blockers with owners, files/URLs/selectors inspected, and the first safe next command. State explicitly whether downstream work is **unblocked**, **partially unblocked**, or **blocked**.

## Evidence contract

| Contract field | Requirement for Day 06 |
|---|---|
