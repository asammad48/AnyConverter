# Phase 03 · Day 14: Publish the Phase 03 handoff
...
Complete **publish the phase 03 handoff**. End the day with **A prioritized, fact-checked rewrite packet with acceptance tests and unresolved facts.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** All Phase 03 briefs/evidence; Phase 04 Day 01.
...
3. **Research/decision** — Freeze page queue and factual claims.
4. **Research/decision** — attach Phase 02 links; enumerate unknown limits/network calls; identify performance-sensitive content changes.
...
- A concise handoff for Phase 04 Day 01.
...
Pass to Phase 04 Day 01: the decision summary, evidence-log path, raw artifact references, exact known/unknown list, unresolved blockers with owners, files/URLs/selectors inspected, and the first safe next command. State explicitly whether downstream work is **unblocked**, **partially unblocked**, or **blocked**.
