# Phase 03 · Day 06: Brief PDF compression and organization
...
Complete **brief pdf compression and organization**. End the day with **Implementation-ready briefs for Compress/Optimize and Organize PDF without promising unmeasured savings.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** `pdf-compress/index.html`, `optimize-pdf/index.html`, `organize-pdf/index.html`.
...
3. **Research/decision** — Verify controls and output behavior.
4. **Research/decision** — avoid invented compression ratios; document browser constraints; specify contextual links.
...
for p in ['robots.txt','sitemap.xml','pdf-compress/index.html']:
