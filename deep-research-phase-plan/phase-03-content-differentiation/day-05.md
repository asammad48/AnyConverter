# Phase 03 · Day 05: Brief PDF merge and split workflows
...
Complete **brief pdf merge and split workflows**. End the day with **Implementation-ready briefs for Merge PDF and Split PDF with verified examples and constraints.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** `pdf-merge/index.html`, `pdf-split/index.html`, their loaded scripts/assets, Day 02 fact sheet.
...
3. **Research/decision** — Exercise inputs.
4. **Research/decision** — capture valid/invalid cases; write example and troubleshooting copy; map merge/split/organize links.
...
for p in ['robots.txt','sitemap.xml','pdf-merge/index.html']:
