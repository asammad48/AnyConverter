# Phase 03 · Day 12: Review privacy, safety, and language
...
Complete **review privacy, safety, and language**. End the day with **A review log resolving or blocking every factual and trust-sensitive claim.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Days 05–11 briefs; `privacy/index.html`; `security/index.html`; Phase 01 redaction result.
...
3. **Research/decision** — Engineering-check behavior.
4. **Research/decision** — privacy-review network claims; native-speaker review any localized copy; remove or mark unsupported claims.
