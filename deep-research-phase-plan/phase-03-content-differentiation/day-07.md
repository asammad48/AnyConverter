# Phase 03 · Day 07: Brief PDF conversion workflows
...
Complete **brief pdf conversion workflows**. End the day with **Implementation-ready briefs for JPG to PDF and PDF to JPG.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** `jpg-to-pdf/index.html`, `pdf-to-jpg/index.html`, `image-converter/index.html`.
...
- Read [`day-06.md`](day-06.md) and its evidence log before starting.
...
3. **Research/decision** — Test supported formats and batch behavior.
4. **Research/decision** — document quality controls; create concrete synthetic examples; note memory/error cases.
...
for p in ['robots.txt','sitemap.xml','jpg-to-pdf/index.html']:
...
- A concise handoff for [`day-08.md`](day-08.md).
...
Pass to [`day-08.md`](day-08.md): the decision summary, evidence-log path, raw artifact references, exact known/unknown list, unresolved blockers with owners, files/URLs/selectors inspected, and the first safe next command. State explicitly whether downstream work is **unblocked**, **partially unblocked**, or **blocked**.

## Evidence contract

| Contract field | Requirement for Day 07 |
|---|---|
