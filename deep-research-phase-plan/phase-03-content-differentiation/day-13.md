# Phase 03 · Day 13: Validate briefs against real UIs
...
- **Inspect exactly:** All targeted `index.html` files; browser at 360px and desktop widths.
...
3. **Research/decision** — Locate insertion points.
4. **Research/decision** — verify proposed examples fit UI; test keyboard flow; ensure sections do not obstruct core task; record screenshots only as evidence.
