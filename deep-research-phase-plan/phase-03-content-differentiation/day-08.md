# Phase 03 · Day 08: Brief PDF trust-sensitive tools
...
Complete **brief pdf trust-sensitive tools**. End the day with **Implementation-ready briefs for OCR, Redact/Blackout, and PDF Security using Phase 01 safety evidence.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** `ocr-pdf/index.html`, `redact-pdf/index.html`, `pdf-security/index.html`; Phase 01 Days 09–11.
...
3. **Research/decision** — Verify OCR/network behavior.
4. **Research/decision** — inherit redaction decision; avoid absolute security claims; require security/privacy stakeholder review.
...
for p in ['robots.txt','sitemap.xml','ocr-pdf/index.html']:
