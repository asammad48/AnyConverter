# Phase 03 · Day 04: Write the content component specification
...
Complete **write the content component specification**. End the day with **A reusable but non-boilerplate brief for intro, example, mechanics, limits, privacy, errors, and next-step links.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Phase 03 page template; Phase 02 link graph; `SEO_SPEC.md`.
...
3. **Research/decision** — Define required fields and selector placement.
4. **Research/decision** — distinguish factual fields from editorial copy; add fact-check and review gates.
...
for p in ['robots.txt','sitemap.xml','SEO_SPEC.md']:
