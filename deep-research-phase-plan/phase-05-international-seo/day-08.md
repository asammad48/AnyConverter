# Phase 05 · Day 08: Define German and French pilot gates
...
Complete **define german and french pilot gates**. End the day with **A go/hold rubric and candidate list capped at 10–15 tools per language.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** GSC country/query evidence when available; Phase 05 candidate list; core cluster priorities.
...
3. **Research/decision** — Score demand, cluster fit, translation capacity, parity, and maintenance.
4. **Research/decision** — select only supported candidates; otherwise record hold and needed evidence.
