# Phase 05 · Day 02: Measure English-Spanish parity
...
Complete **measure english-spanish parity**. End the day with **A page-and-feature parity matrix with justified gaps, not a demand claim.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** English tool directories; corresponding `es/` directories; Phase 03 priority queue.
...
3. **Research/decision** — Compare tool existence, UI controls, examples, legal links, and core behavior.
4. **Research/decision** — classify intentional versus unexplained gaps.
...
for p in ['robots.txt','sitemap.xml','es/']:
