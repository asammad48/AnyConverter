# Phase 05 · Day 10: Assess Arabic RTL readiness
...
Complete **assess arabic rtl readiness**. End the day with **A component-level RTL test report and launch blocking list; no claim of translation quality without native review.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Representative HTML/CSS/components; browser `dir="rtl"` test; 360px/desktop viewports.
...
3. **Research/decision** — Test logical spacing, icons, text fields, mixed LTR tokens, focus order, and screenshots.
4. **Research/decision** — list required code changes; obtain Arabic review.
...
for p in ['robots.txt','sitemap.xml','dir="rtl"']:
