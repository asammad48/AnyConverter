# Phase 05 · Day 05: Audit Spanish content quality
...
Complete **audit spanish content quality**. End the day with **A native-review queue covering UI, headings, examples, anchors, and tool-specific body copy.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Representative `es/**/index.html`; matching English pages; Phase 03 fact sheets.
...
3. **Research/decision** — Detect untranslated/repeated strings.
4. **Research/decision** — compare facts and workflows; have a native speaker assess natural intent; mark quality unknown without that review.
