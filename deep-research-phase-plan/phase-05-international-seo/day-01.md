# Phase 05 · Day 01: Inventory localized URLs
...
Complete **inventory localized urls**. End the day with **A locale/path/content inventory beginning with Spanish and separating existing pages from planned pilots.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** `sitemap.xml`, `/es/` directory tree, `es/index.html`, localized links in HTML.
...
- Read [`../phase-05-international-seo.md`](../phase-05-international-seo.md) and prerequisites produced by earlier phases and its evidence log before starting.
...
3. **Research/decision** — Enumerate locale prefixes and pages.
4. **Research/decision** — compare sitemap representation; record status/canonical/lang attributes locally; do not infer indexation.
