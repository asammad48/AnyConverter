# Phase 05 · Day 09: Define Portuguese pilot gates

**Phase timeline preserved from the source report:** Week 5, then Weeks 9-11 pilots. **Planning unit:** one focused workday.

## Objective and end-of-day outcome

Complete **define portuguese pilot gates**. End the day with **A Brazil-aware go/hold rubric and candidate list capped at 10–15 tools.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Source of truth:** [`../phase-05-international-seo.md`](../phase-05-international-seo.md).
...
- **Inspect exactly:** GSC Brazil/Portuguese evidence; external approved sources; candidate list.
- **External surfaces, only when access is authorized:** GSC, deployed locale URLs, approved keyword sources, and native-speaker review.
...
- Phase 05 consumes the accepted outputs named in the root [dependency matrix](../README.md#cross-phase-dependency-matrix). If any required milestone is missing, continue only with work that does not depend on it.
...
1. Is the page technically discoverable as its own locale version?
2. Is phrasing supported by native review or query evidence?
3. Can the locale be maintained at feature and factual parity?
...
3. **Research/decision** — Assess pt-BR phrasing and region intent.
4. **Research/decision** — document locale-code decision; require native review and evidence; hold rather than default from Spanish.
