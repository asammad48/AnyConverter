# Phase 05 · Day 12: Design locale release gates
...
Complete **design locale release gates**. End the day with **A locale-specific extension to Phase 04 covering lang/dir, canonical, hreflang, parity, and native review.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Phase 04 gate packet; Days 01–11 reports; localized URLs.
...
3. **Research/decision** — Define machine checks and human sign-offs.
4. **Research/decision** — set stop-ship on broken reciprocal clusters or cross-locale canonicals; document rollback/removal.
