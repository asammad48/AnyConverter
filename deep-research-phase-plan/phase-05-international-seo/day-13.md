# Phase 05 · Day 13: Validate one pilot specification
...
Complete **validate one pilot specification**. End the day with **A dry-run validation of a proposed locale/tool cluster without publishing pages.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Highest-evidence approved pilot, or Spanish remediation spec if all pilots are held.
...
3. **Research/decision** — Apply validators to mock/branch spec.
4. **Research/decision** — trace every alternate and canonical; simulate missing locale; confirm no mass-generation dependency.
