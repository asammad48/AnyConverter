# Phase 05 · Day 11: Assess Urdu demand and RTL readiness
...
Complete **assess urdu demand and rtl readiness**. End the day with **A separate Urdu go/hold decision that does not inherit Arabic or Hindi assumptions.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Authorized GSC evidence; approved external research; RTL test surfaces.
...
3. **Research/decision** — Research Urdu-script queries and audience signals.
4. **Research/decision** — test mixed-script UI; require native review; mark demand/quality unknown when evidence absent.
