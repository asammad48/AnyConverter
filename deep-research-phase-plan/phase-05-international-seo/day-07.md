# Phase 05 · Day 07: Specify Spanish remediation
...
Complete **specify spanish remediation**. End the day with **An ordered repository change plan for canonical, hreflang, translation, examples, and links.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Days 01–06 findings; exact affected `es/**/index.html`; `sitemap.xml`.
...
3. **Research/decision** — Rank technical before editorial defects.
4. **Research/decision** — specify selectors and reciprocal pages; require native review; define rollback for locale routing.
