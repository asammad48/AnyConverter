# Phase 05 · Day 04: Audit hreflang clusters
...
- **Inspect exactly:** Localized and English HTML; `sitemap.xml`; rendered DOM; Rich Results not used as hreflang authority.
...
3. **Research/decision** — Parse all annotations.
4. **Research/decision** — construct clusters; validate reciprocal targets and language codes; compare HTML/sitemap methods for conflicts.
