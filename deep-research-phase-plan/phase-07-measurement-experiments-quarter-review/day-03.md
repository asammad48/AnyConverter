# Phase 07 · Day 03: Specify GSC weekly review
...
Complete **specify gsc weekly review**. End the day with **An exact console/export runbook for indexation, sitemaps, performance, devices, countries, and crawl stats.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** `https://search.google.com/search-console`; Phase 01 representative URLs; sitemap.
...
3. **Research/decision** — Define property and comparison windows.
4. **Research/decision** — list filters/exports/screenshots; sample URLs consistently; mark inaccessible reports unknown.
...
for p in ['robots.txt','sitemap.xml','https://search.google.com/search-console']:
