# Phase 07 · Day 08: Define privacy-title experiment
...
Complete **define privacy-title experiment**. End the day with **A deployable test protocol for generic versus privacy-specific titles without unverified claims.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Candidate pages; Phase 04 claim matrix; GSC CTR definition.
...
3. **Research/decision** — Verify claim per tool.
4. **Research/decision** — lock page set and dates; control other edits; define CTR/position guardrails and minimum duration.
