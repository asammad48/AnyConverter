# Phase 07 · Day 06: Create the experiment register
...
Complete **create the experiment register**. End the day with **A governance-ready register with hypothesis, control, variant, primary metric, guardrails, window, and status.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Phase 07 experiment table; KPI dictionary; affected page specs.
...
3. **Research/decision** — Template eight candidate experiments.
4. **Research/decision** — enforce one primary metric; document concurrent changes; require sufficient baseline before launch.
