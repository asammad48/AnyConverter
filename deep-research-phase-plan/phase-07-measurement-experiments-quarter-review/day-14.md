# Phase 07 · Day 14: Publish next-quarter handoff
...
Complete **publish next-quarter handoff**. End the day with **An evidence-linked roadmap recommendation with owners, dependencies, held bets, and no ranking promises.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Day 13 packet; all phase milestone registers; original phase overviews.
...
3. **Research/decision** — Select work by verified impact and readiness.
4. **Research/decision** — document consumed/produced milestones; preserve unresolved facts; define first unblocked next action.
...
- A concise handoff for the approved next-quarter roadmap.
...
Pass to the approved next-quarter roadmap: the decision summary, evidence-log path, raw artifact references, exact known/unknown list, unresolved blockers with owners, files/URLs/selectors inspected, and the first safe next command. State explicitly whether downstream work is **unblocked**, **partially unblocked**, or **blocked**.
