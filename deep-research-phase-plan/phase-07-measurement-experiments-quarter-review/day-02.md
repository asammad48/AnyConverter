# Phase 07 · Day 02: Build the weekly evidence log
...
Complete **build the weekly evidence log**. End the day with **A reusable Monday reporting sheet with raw-export references and unknown/pending states.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Daily evidence template; GSC/analytics/crawl report fields; KPI dictionary.
...
3. **Research/decision** — Create reporting schema.
4. **Research/decision** — include date/timezone/filter annotations; link immutable exports; prevent blanks from being interpreted as zero.
