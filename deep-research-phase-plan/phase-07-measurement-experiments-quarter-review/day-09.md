# Phase 07 · Day 09: Define content-block experiment
...
Complete **define content-block experiment**. End the day with **A deployable protocol for example or troubleshooting content with tool-start and long-tail metrics.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Phase 03 content briefs; analytics event validation; GSC query export.
...
3. **Research/decision** — Choose one intervention.
4. **Research/decision** — specify selector/copy; establish pre-period; track core-task errors and page experience; avoid weekly conclusions.
