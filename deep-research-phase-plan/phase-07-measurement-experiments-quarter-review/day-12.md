# Phase 07 · Day 12: Prepare cannibalization and opportunity review
...
Complete **prepare cannibalization and opportunity review**. End the day with **A query-page analysis method for competing URLs, weak CTR, and positions 11–20 without declaring causes prematurely.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** GSC page/query exports; canonical inventory; experiment register.
...
3. **Research/decision** — Join query/page data carefully.
4. **Research/decision** — flag patterns across adequate windows; inspect intent and canonicals; require review before consolidation.
