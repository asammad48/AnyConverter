# Phase 07 · Day 07: Prioritize experiments from evidence
...
Complete **prioritize experiments from evidence**. End the day with **A ranked launch/hold queue; low-data pages remain held rather than forced into tests.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Latest GSC/analytics exports; Phase 03 rewrite queue; Phase 02 link map.
...
3. **Research/decision** — Identify impressions and product usage.
4. **Research/decision** — assess contamination and sample sufficiency; select the smallest interpretable test; document holds.
