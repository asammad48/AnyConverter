# Phase 07 · Day 11: Prepare the Week 12 regression crawl
...
Complete **prepare the week 12 regression crawl**. End the day with **An exact crawl configuration, canonical/indexability comparison method, and artifact directory convention.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** `sitemap.xml`, `robots.txt`, Phase 01 baseline, Phase 04 gate.
...
3. **Research/decision** — Freeze user agent/render mode/scope.
4. **Research/decision** — define expected URL set; capture status/canonical/noindex/links; document production access fallback.
