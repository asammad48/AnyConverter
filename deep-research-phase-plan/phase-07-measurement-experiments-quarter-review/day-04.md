# Phase 07 · Day 04: Specify product analytics review
...
Complete **specify product analytics review**. End the day with **A privacy-safe runbook for starts, completions, errors, downloads/copies, and returning use.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Phase 04 event dictionary; authorized analytics console; priority tool list.
...
3. **Research/decision** — Validate event instrumentation first.
4. **Research/decision** — define funnels and error denominator; prohibit sensitive dimensions; separate missing events from zero activity.
