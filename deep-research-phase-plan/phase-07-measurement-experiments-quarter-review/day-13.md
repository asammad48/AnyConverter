# Phase 07 · Day 13: Run or rehearse quarter decision meeting
...
Complete **run or rehearse quarter decision meeting**. End the day with **A decision packet populated only with available evidence and explicit unknowns.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Weekly logs; experiment register; crawl/cannibalization outputs; Phase 06 handoff.
...
- Read [`day-12.md`](day-12.md) and its evidence log before starting.
...
3. **Research/decision** — Compare to Week 1 using compatible windows.
4. **Research/decision** — review product and SEO guardrails; label experiments inconclusive when thresholds fail; draft stop/start/continue decisions.
...
- A concise handoff for [`day-14.md`](day-14.md).
...
Pass to [`day-14.md`](day-14.md): the decision summary, evidence-log path, raw artifact references, exact known/unknown list, unresolved blockers with owners, files/URLs/selectors inspected, and the first safe next command. State explicitly whether downstream work is **unblocked**, **partially unblocked**, or **blocked**.

## Evidence contract

| Contract field | Requirement for Day 13 |
|---|---|
