# Phase 07 · Day 01: Define KPI dictionary

**Phase timeline preserved from the source report:** Ongoing and Week 12. **Planning unit:** one focused workday.

## Objective and end-of-day outcome

Complete **define kpi dictionary**. End the day with **A versioned definition for every roadmap KPI, including formula, source, dimensions, and unavailable-data behavior.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Source of truth:** [`../phase-07-measurement-experiments-quarter-review.md`](../phase-07-measurement-experiments-quarter-review.md).
...
- **Inspect exactly:** Phase 07 KPI list; Phase 01 baseline; Phase 04 analytics dictionary.
- **External surfaces, only when access is authorized:** GSC, analytics, PageSpeed Insights/CrUX, crawl outputs, and outreach evidence.
...
- Read [`../phase-07-measurement-experiments-quarter-review.md`](../phase-07-measurement-experiments-quarter-review.md) and prerequisites produced by earlier phases and its evidence log before starting.
- Phase 07 consumes the accepted outputs named in the root [dependency matrix](../README.md#cross-phase-dependency-matrix). If any required milestone is missing, continue only with work that does not depend on it.
...
1. Are metric definitions and date windows comparable?
2. Is there enough uncontaminated evidence to decide?
3. What remains inconclusive or unknown rather than positive/negative?
...
3. **Research/decision** — Define numerator/denominator and branded filter.
4. **Research/decision** — distinguish GSC, analytics, CrUX, crawl, and outreach sources; forbid mixing incompatible windows.
