# Phase 07 · Day 10: Define internal-link experiment
...
Complete **define internal-link experiment**. End the day with **A deployable protocol for contextual workflow links with click and crawl/impression outcomes.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Phase 02 link graph; `related_tool_clicked`; crawl report.
...
3. **Research/decision** — Select comparable pages.
4. **Research/decision** — define anchors/placement; validate analytics; monitor orphan/depth changes; avoid simultaneous URL moves.
...
for p in ['robots.txt','sitemap.xml','related_tool_clicked']:
