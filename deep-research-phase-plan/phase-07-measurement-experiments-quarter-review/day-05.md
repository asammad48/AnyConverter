# Phase 07 · Day 05: Specify CWV and crawl review
...
Complete **specify cwv and crawl review**. End the day with **A joined but non-conflated procedure for field CWV, lab diagnostics, and regression crawl findings.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** GSC CWV; PageSpeed Insights; Phase 04 Lighthouse artifacts; sitemap crawler.
...
3. **Research/decision** — Record URL-group field status.
4. **Research/decision** — use lab data diagnostically; compare crawl inventory with intended URLs; preserve environment details.
