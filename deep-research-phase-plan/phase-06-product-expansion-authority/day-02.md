# Phase 06 · Day 02: Inventory cluster gaps
...
Complete **inventory cluster gaps**. End the day with **A current-capability versus candidate matrix for the three core clusters.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** `sitemap.xml`, `pdf-tools/index.html`, `developer-tools/index.html`, Browser/Device inventory from Phase 02.
...
- Read [`day-01.md`](day-01.md) and its evidence log before starting.
...
3. **Research/decision** — Map existing tools and workflows.
4. **Research/decision** — identify adjacent unmet tasks; flag duplicates; do not equate a gap with demand.
...
- A concise handoff for [`day-03.md`](day-03.md).
...
Pass to [`day-03.md`](day-03.md): the decision summary, evidence-log path, raw artifact references, exact known/unknown list, unresolved blockers with owners, files/URLs/selectors inspected, and the first safe next command. State explicitly whether downstream work is **unblocked**, **partially unblocked**, or **blocked**.

## Evidence contract

| Contract field | Requirement for Day 02 |
|---|---|
