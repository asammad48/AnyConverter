# Phase 06 · Day 11: Define the linkable asset thesis
...
Complete **define the linkable asset thesis**. End the day with **An evidence-backed outline for one technically useful privacy/local-processing asset.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Phase 06 Authority Work topics; Phase 01 redaction evidence; Phase 04 request inventory.
...
3. **Research/decision** — Choose a claim that repository evidence can support.
4. **Research/decision** — outline diagrams/tests/sources; exclude promotional or unverified superiority claims.
