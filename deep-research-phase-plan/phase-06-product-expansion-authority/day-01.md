# Phase 06 · Day 01: Create the five-gate scoring rubric

**Phase timeline preserved from the source report:** Weeks 6-8. **Planning unit:** one focused workday.

## Objective and end-of-day outcome

Complete **create the five-gate scoring rubric**. End the day with **A weighted, evidence-cited rubric for search intent, competition, cluster fit, frontend feasibility, and differentiation.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Source of truth:** [`../phase-06-product-expansion-authority.md`](../phase-06-product-expansion-authority.md).
...
- **Inspect exactly:** Phase 06 Product Decision Rule; `TOOLS_SPEC.md`; existing keyword research in `reports/`.
- **External surfaces, only when access is authorized:** Official format/library documentation, approved SERP research, and publication guidelines.
...
- Read [`../phase-06-product-expansion-authority.md`](../phase-06-product-expansion-authority.md) and prerequisites produced by earlier phases and its evidence log before starting.
- Phase 06 consumes the accepted outputs named in the root [dependency matrix](../README.md#cross-phase-dependency-matrix). If any required milestone is missing, continue only with work that does not depend on it.
...
1. Does the candidate pass all five gates with cited evidence?
2. Can it run client-side without contradicting privacy claims?
3. Is the asset or outreach target genuinely useful and relevant?
...
3. **Research/decision** — Define scoring anchors and minimum evidence.
4. **Research/decision** — make any failed privacy/feasibility gate disqualifying; prohibit unsupported demand scores.
...
for p in ['robots.txt','sitemap.xml','TOOLS_SPEC.md']:
