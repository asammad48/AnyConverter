# Phase 06 · Day 07: Select or hold the first candidate
...
Complete **select or hold the first candidate**. End the day with **A transparent go/hold decision and runner-up, with no build authorized unless every gate passes.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Days 01–06 scorecards; Phase 01/04 privacy and performance constraints.
...
3. **Research/decision** — Normalize evidence quality.
4. **Research/decision** — apply disqualifiers; document dissent and unknowns; obtain product/engineering approval.
