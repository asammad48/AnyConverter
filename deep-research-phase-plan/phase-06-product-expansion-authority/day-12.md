# Phase 06 · Day 12: Research editorial audiences
...
Complete **research editorial audiences**. End the day with **A relevance-qualified prospecting procedure and seed list with source/date, not outreach outcomes.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Approved web research; existing `reports/backlink-campaign-2026-08-26.md`; prospective publication guidelines.
...
3. **Research/decision** — Define relevance/quality checks.
4. **Research/decision** — record contact route from public sources; exclude paid/link-scheme targets; respect privacy and terms.
...
for p in ['robots.txt','sitemap.xml','reports/backlink-campaign-2026-08-26.md']:
