# Phase 06 · Day 08: Write the selected tool product brief
...
Complete **write the selected tool product brief**. End the day with **An implementation-ready product brief or a hold-resolution plan if no candidate passed.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Selected candidate evidence; `TOOLS_SPEC.md`; `DESIGN_SYSTEM.md`; target hub spec.
...
- Read [`day-07.md`](day-07.md) and its evidence log before starting.
...
3. **Research/decision** — Define user stories, formats, limits, offline/network behavior, states, selectors, analytics, accessibility, and scope exclusions..
4. **Research/decision** — Compare the observations against the phase overview and document the decision.
...
- A concise handoff for [`day-09.md`](day-09.md).
...
Pass to [`day-09.md`](day-09.md): the decision summary, evidence-log path, raw artifact references, exact known/unknown list, unresolved blockers with owners, files/URLs/selectors inspected, and the first safe next command. State explicitly whether downstream work is **unblocked**, **partially unblocked**, or **blocked**.

## Evidence contract

| Contract field | Requirement for Day 08 |
|---|---|
