# Phase 06 · Day 05: Research JSON-to-types and CSV diagnostics
...
- **Inspect exactly:** Official TypeScript/Zod/CSV references; existing JSON/CSV tool pages and scripts.
...
3. **Research/decision** — Test frontend feasibility.
4. **Research/decision** — map unique validation/examples; assess overlap; cite demand evidence or mark it unknown.
