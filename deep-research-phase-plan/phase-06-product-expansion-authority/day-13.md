# Phase 06 · Day 13: Write outreach and measurement protocol
...
Complete **write outreach and measurement protocol**. End the day with **A reviewed outreach template set, contact log schema, and ethical stop rules.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Day 11 asset outline; Day 12 prospects; Phase 07 KPI definitions.
...
3. **Research/decision** — Tailor pitches by audience.
4. **Research/decision** — define sent/replied/published evidence; prohibit fabricated placements; specify opt-out and follow-up limit.
