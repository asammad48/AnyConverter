# Phase 06 · Day 06: Research Unicode and cron candidates
...
Complete **research unicode and cron candidates**. End the day with **Evidence packs and scores for Unicode inspector/normalizer and Cron visualizer.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Unicode Standard; cron dialect documentation; `cron-expression-parser/index.html`; text/developer pages.
...
3. **Research/decision** — Define supported standards/dialects.
4. **Research/decision** — identify test corpus; evaluate differentiation and fit; avoid claiming universal cron compatibility.
...
for p in ['robots.txt','sitemap.xml','cron-expression-parser/index.html']:
