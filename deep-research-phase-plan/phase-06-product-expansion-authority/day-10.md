# Phase 06 · Day 10: Design integration and launch paths
...
Complete **design integration and launch paths**. End the day with **A sitemap, canonical, hub-link, related-link, content, and measurement specification.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Phase 02 architecture; Phase 03 content spec; `sitemap.xml`; target hub/page files.
...
3. **Research/decision** — Select URL without moving existing pages.
4. **Research/decision** — map crawl paths; prepare unique examples and troubleshooting; define launch gate.
