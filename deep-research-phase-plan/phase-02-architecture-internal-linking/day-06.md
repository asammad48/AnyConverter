# Phase 02 · Day 06: Design breadcrumb semantics
...
Complete **design breadcrumb semantics**. End the day with **A page-level breadcrumb map and accessible markup contract.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Hub specs; representative tool HTML; `SEO_SPEC.md`; `DESIGN_SYSTEM.md`.
...
3. **Research/decision** — Define labels and parent relationships.
4. **Research/decision** — specify visible navigation and optional BreadcrumbList validation; avoid breadcrumbs that imply false URL hierarchy.
