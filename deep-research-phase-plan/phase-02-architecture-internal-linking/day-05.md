# Phase 02 · Day 05: Specify the Browser/Device hub
...
Complete **specify the browser/device hub**. End the day with **A repository-ready specification for the missing or existing Browser/Device hub without choosing an unverified URL migration.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** `browser-info/index.html`, `keyboard-tester/index.html`, `dead-pixel-checker/index.html`, `screen-resolution/index.html`, `viewport-size/index.html`, `webcam-tester/index.html`.
...
3. **Research/decision** — Confirm whether a canonical hub exists.
4. **Research/decision** — compare candidate URL against sitemap/history; specify content and child links; require approval before introducing a new URL.
...
for p in ['robots.txt','sitemap.xml','browser-info/index.html']:
