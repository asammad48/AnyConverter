# Phase 02 · Day 07: Build the internal-link graph
...
Complete **build the internal-link graph**. End the day with **A source-target-anchor-purpose matrix for all priority pages.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Days 03–05 hub specs; Phase 03 priority candidates.
...
3. **Research/decision** — Create bidirectional hub/tool links.
4. **Research/decision** — add workflow-next links; cap repetitive blocks; ensure anchor language describes destination.
