# Phase 02 · Day 02: Define cluster governance
...
Complete **define cluster governance**. End the day with **An approved classification rule for PDF, Developer/Data, Browser/Device, and secondary clusters.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** Phase 02 overview; Day 01 inventory; `TOOLS_SPEC.md`, `FILE_STRUCTURE.md`.
...
3. **Research/decision** — Write inclusion/exclusion rules.
4. **Research/decision** — resolve ambiguous tools by user workflow; define hub ownership and no-move rule; log stakeholder decisions.
