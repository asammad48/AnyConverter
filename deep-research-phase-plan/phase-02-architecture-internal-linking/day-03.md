# Phase 02 · Day 03: Audit the PDF hub
...
Complete **audit the pdf hub**. End the day with **A concrete PDF hub gap and linking specification.** This brief authorizes preparation, research, validation, and the explicitly described later-roadmap work only; it does not authorize inventing results or silently widening scope.
...
- **Inspect exactly:** `pdf-tools/index.html`; PDF page directories listed in `sitemap.xml`.
...
3. **Research/decision** — Inventory child links, labels, headings, canonical, and return links.
4. **Research/decision** — map task sequences; identify missing or random links.
