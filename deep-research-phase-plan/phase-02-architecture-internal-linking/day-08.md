# Phase 02 · Day 08: Review homepage positioning
...
- **Inspect exactly:** `index.html`, Phase 02 candidate title/H1, `privacy/index.html`, `security/index.html`.
...
3. **Research/decision** — Inventory current claims.
4. **Research/decision** — verify local-processing claims per linked tool; draft title/H1 options; map primary hub entry points; request copy/privacy review.
