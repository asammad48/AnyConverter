(function () {
  ...
  function updatePreview(files) {
    ...
    Array.from(files).forEach(function (f, i) {
      ...
      item.innerHTML = '<span style="color:var(--color-text-2,#3F3A36)">' + (i+1) + '.</span><span>' + f.name + '</span><span style="color:var(--color-text-3,#7C7169);margin-left:auto">' + (f.size/1024).toFixed(1) + ' KB</span>';
